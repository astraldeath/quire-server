...
The Docker build includes reader commit `43561c671dfec6edb4c18f13eb4c43ba9954565b`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
