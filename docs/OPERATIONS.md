...
The Docker build includes reader commit `705b07a67f90a80783b364e98b919fae1190852a`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
