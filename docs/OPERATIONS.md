...
The Docker build includes reader commit `52c22819c08cef44067a907e06a3ca286f765797`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
