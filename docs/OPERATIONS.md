...
The Docker build includes reader commit `de59586d4aae36e83b427414830e22679999f9b5`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
