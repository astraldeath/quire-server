...
The Docker build includes reader commit `f353501b98440f3e818be40a2314cef363f05cc4`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
