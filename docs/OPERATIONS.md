...
The Docker build includes reader commit `30233977760a33dce58bfca296afb051b4fc1a5e`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
