...
The Docker build includes reader commit `5e253a6aae7bb7772c7e994db24b65bc5ee54579`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
