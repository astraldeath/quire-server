...
The Docker build includes reader commit `5c39bf07107d5eaaf3064077e1dccd1c58c30ba1`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
