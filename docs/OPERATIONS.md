...
The Docker build includes reader commit `381d5a033c206c3c11d51de9184d168fef990522`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
