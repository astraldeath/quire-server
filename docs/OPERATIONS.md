...
The Docker build includes reader commit `c990a80925fd7b730711945c6a94d42159dc5c93`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
