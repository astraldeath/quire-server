...
The Docker build includes reader commit `7d06ac0a8ce5a4d27dd1ecda3ad761cfcfcb5dbd`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
