...
The Docker build includes reader commit `ed34694310ffbfd654ccff16b5c13fefd1b44906`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
