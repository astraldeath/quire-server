...
The Docker build includes reader commit `994e5efad3bf5bdad491837f30b821a93583889c`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
