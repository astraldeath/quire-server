...
The Docker build includes reader commit `706fb71e3004816a8952e0b273ea6ba83545d047`. `QUIRE_READER_REF` is the build argument for selecting another reviewed revision.
